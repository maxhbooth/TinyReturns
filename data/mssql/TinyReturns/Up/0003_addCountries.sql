...
ALTER TABLE [Portfolio].[Portflio]  WITH CHECK ADD  CONSTRAINT [FK_Portfolio_CountryId] FOREIGN KEY([CountryId])
REFERENCES [Portfolio].[Countries] ([CountryId])
GO

ALTER TABLE [Portfolio].[Portflio] CHECK CONSTRAINT [FK_Portfolio_CountryId]
GO

ALTER TABLE [Portfolio].[Portfolio] ADD [CountryId] [nvarchar](255) NOT NULL DEFAULT 0
GO
